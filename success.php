...
if (isset($order_data)) {
    $decoded_order_data = explode('|', base64_decode($order_data));
    
    if (count($decoded_order_data) == 2) {
        $name = $decoded_order_data[0];
        $phone = $decoded_order_data[1];
    }
}
?>
<!DOCTYPE html>
  ...
  <div class="mod success-page">
   <div class="container">
    ...
    <p class="success-page__message_success">
     We will respond to your request shortly, please keep your phone on.
    </p>
   ...
   $(document).ready(function () {
       ...
       //
        ...
        $(".mod a.success-page__form__button").click(function () {
            ...
            $("form.success-page__form div.success-page__form__container").empty().html("Thank you, information was saved.");
            return false;
        });
    })
  </script>
